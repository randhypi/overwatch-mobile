...
class TransactionDetailSheet extends StatefulWidget {
  ...
  const TransactionDetailSheet({super.key, required this.group});

  @override
  State<TransactionDetailSheet> createState() => _TransactionDetailSheetState();
}

class _TransactionDetailSheetState extends State<TransactionDetailSheet> with SingleTickerProviderStateMixin {
      ...
      child: Column(
        children: [
           ...
           Padding(
             ...
             child: Row(
               children: [
                 const Text("Transaction Details", style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold)),
                 const Spacer(),
                 Container(
                   ...
                   child: Text(widget.group.refNum, style: const TextStyle(color: AppColors.primary, fontFamily: 'monospace')),
                 )
               ],
             ),
           ),
      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            Text("No $type Data Found", style: TextStyle(color: Colors.grey.withOpacity(0.5))),
          ],
        ),
      );
    }
      ...
      itemBuilder: (context, index) {
        ...
        return Container(
          ...
          child: Column(
             ...
             children: [
                Text("Log #${index + 1}", style: const TextStyle(color: AppColors.secondaryText, fontSize: 12)),
                ...
                if (pair.response != null)
                  ...
                  _buildCodeBlock("Response", "Waiting for response...", isWaiting: true),
             ],
          ),
        );
      },
  ...
  Widget _buildCodeBlock(String label, String content, {bool isWaiting = false}) {
    return Container(
